...
export default function Protsessor() {
    useGSAP(() => {
        const card_box_time_line = gsap
            .timeline({
                scrollTrigger: {
                    trigger: ".protsessor_wrap",
                    start: "top top+=50%",
                    end: "bottom bottom",
                    scrub: 1.5,
                },
    ...
    return (
        <section className="protsessor_wrap">
            <section className="protsessor_section">
                <div className="protsessor_container">
                    ...
                    <div className="intel_info">
                        <h6 className="intel_info_title">
                            <b>
                                ...
                                <span className="info_title_span">Confidential Computing</span>
                            </b>
                            <br />
                    ...
                    <div className="trust_logo_box">
                        ...
                        <svg width="131" height="20" viewBox="0 0 131 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M31.4209 6.01953C30.1199 6.01953 28.8189 6.52978 27.8181 7.34617V6.12158H24.5156V19.1839H27.9182V10.8158C28.6188 9.79535 29.8197 9.18306 31.0206 9.18306C32.2215 9.18306 31.9213 9.18305 32.4216 9.38715V6.01953H31.4209Z"
                                fill="black"
                            />
                            <path
                                fillRule="evenodd"
                            ...
                            <path
                                ...
                                fill="black"
                            />
                            <path fillRule="evenodd" clipRule="evenodd" d="M40.6289 14.183L44.1315 6.12109H47.7343L41.8298 19.2854H39.4279L33.5234 6.12109H37.1262L40.6289 14.183Z" fill="black" />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M50.5376 0C51.7385 0 52.7393 1.02049 52.7393 2.24508C52.7393 3.46967 51.7385 4.49016 50.5376 4.49016C49.3367 4.49016 48.3359 3.46967 48.3359 2.24508C48.3359 1.02049 49.3367 0 50.5376 0Z"
                                fill="black"
                            />
