...
export default function Trust() {
    useGSAP(() => {
        ...
        mainTL.add(title_time_line, 0)

        const horse_time_line = gsap
            .timeline({
                // scrollTrigger: {
                //     trigger: ".trust-evolves",
                //     start: "-40% top",
        ...
        mainTL.add(horse_time_line, 0.5)
